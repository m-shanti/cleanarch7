using cleanarch7.Core.Interfaces;
using cleanarch7.Core.ProjectAggregate;
using cleanarch7.Core.ProjectAggregate.Events;
using cleanarch7.Core.ProjectAggregate.Handlers;
using Moq;
using Xunit;

namespace cleanarch7.UnitTests.Core.Handlers;
